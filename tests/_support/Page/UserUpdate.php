...
class UserUpdate extends \AcceptanceTester
{
    ...
    public static function URL_AddStateForm($id)   { return parent::$URL_UserAccess."/user/add-state?user_id=$id";}
    public static function URL_AddProgramForm($id) { return parent::$URL_UserAccess."/user/add-program?user_id=$id";}
