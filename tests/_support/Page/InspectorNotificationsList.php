...
class InspectorNotificationsList extends \AcceptanceTester
{
    public static function URL()                     { return parent::$URL_UserAccess.'/communication/notification-report?trigger=7';}
    public static function URL_InspectionComplete()  { return parent::$URL_UserAccess.'/communication/notification-report?trigger=15';}
    ...
    public static $InspectorLinkHead             = 'table[class*=table] tr>th:nth-of-type(3) a';
    public static $InspectorEmailLinkHead        = 'table[class*=table] tr>th:nth-of-type(4) a';
    public static $InspectorOrganizationLinkHead = 'table[class*=table] tr>th:nth-of-type(5) a';
    ...
    public static function InspectorLine($row)              { return "table[class*=table] tbody>tr:nth-of-type($row)>td:nth-of-type(3)"; }
    public static function InspectorEmailLine($row)         { return "table[class*=table] tbody>tr:nth-of-type($row)>td:nth-of-type(4)"; }
    public static function InspectorOrganizationLine($row)  { return "table[class*=table] tbody>tr:nth-of-type($row)>td:nth-of-type(5)"; }
