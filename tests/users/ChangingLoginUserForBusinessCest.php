...
class ChangingLoginUserForBusinessCest
{
    ...
    public $business1, $id_business1, $id_business1User, $email_Business1, $firstName_Business1, $lastName_Business1, $phone_Business1;
    public $business2, $id_business2, $id_business2User, $email_Business2, $firstName_Business2, $lastName_Business2, $phone_Business2;
...
//    }
    ...
    public function CreateStateAdmin1_ForCreatedState(\Step\Acceptance\User $I)
    {
        ...
        $firstName = $this->firstName_StateAdmin1 = $I->GenerateNameOf('firnam1_');
        $lastName  = $this->lastName_StateAdmin1 = $I->GenerateNameOf('lastnam1_');
        ...
        $I->wait(2);
        $I->waitForElement(Page\UserUpdate::$PasswordField, 150);
        $I->wait(1);
    ...
    public function CreateStateAdmin2_ForCreatedState(\Step\Acceptance\User $I)
    {
        ...
        $firstName = $this->firstName_StateAdmin2 = $I->GenerateNameOf('firnam2_');
        $lastName  = $this->lastName_StateAdmin2 = $I->GenerateNameOf('lastnam2_');
        $password  = $confirmPassword = $this->password;
    ...
    public function CreateStateAdmin3_WithoutState(\Step\Acceptance\User $I)
    {
        ...
        $firstName = $this->firstName_StateAdmin3_WithoutState = $I->GenerateNameOf('firnam3_');
        $lastName  = $this->lastName_StateAdmin3_WithoutState = $I->GenerateNameOf('lastnam3_');
        $password  = $confirmPassword = $this->password;
    ...
    public function CreateCoordinatorUser_WithoutState(Step\Acceptance\User $I)
    {
        ...
        $firstName = $this->firstName_Coordinator5_WithoutState = $I->GenerateNameOf('firnam_5');
        $lastName  = $this->lastName_Coordinator5_WithoutState = $I->GenerateNameOf('lastnam_5');
        $password  = $confirmPassword = $this->password;
    ...
    public function CreateCoordinatorUser_WithoutProgram(Step\Acceptance\User $I)
    {
        ...
        $firstName = $this->firstName_Coordinator4_WithoutProgram = $I->GenerateNameOf('firnam_4');
        $lastName  = $this->lastName_Coordinator4_WithoutProgram = $I->GenerateNameOf('lastnam_4 ');
        $password  = $confirmPassword = $this->password;
    ...
    public function CreateCoordinatorUser_Program1_Program2(Step\Acceptance\User $I)
    {
        ...
        $firstName = $this->firstName_Coordinator3_Prog1_Prog2 = $I->GenerateNameOf('firnam_3');
        $lastName  = $this->lastName_Coordinator3_Prog1_Prog2 = $I->GenerateNameOf('lastnam_3');
        $password  = $confirmPassword = $this->password;
    ...
    public function CreateInspectorUser_WithoutState(Step\Acceptance\User $I)
    {
        ...
        $firstName           = $this->firstName_Inspector5_WithoutState = $I->GenerateNameOf('firnam_5');
        $lastName            = $this->lastName_Inspector5_WithoutState = $I->GenerateNameOf('lastnam_5');
        $password            = $confirmPassword = $this->password;
...
//        $this->nameInspector = $firstName." ".$lastName;
    ...
    public function CreateInspectorUser_WithoutProgram(Step\Acceptance\User $I)
    {
        ...
        $firstName           = $this->firstName_Inspector4_WithoutProgram = $I->GenerateNameOf('firnam_4');
        $lastName            = $this->lastName_Inspector4_WithoutProgram = $I->GenerateNameOf('lastnam_4');
        $password            = $confirmPassword = $this->password;
...
//        $this->nameInspector = $firstName." ".$lastName;
    ...
    public function CreateInspectorUser_Program1_Program2(Step\Acceptance\User $I)
    {
        ...
        $firstName           = $this->firstName_Inspector3_Prog1_Prog2 = $I->GenerateNameOf('firnam_3');
        $lastName            = $this->lastName_Inspector3_Prog1_Prog2 = $I->GenerateNameOf('lastnam_3');
        $password            = $confirmPassword = $this->password;
...
//        $this->nameInspector = $firstName." ".$lastName;
    ...
    public function CreateAuditorUser_WithoutState(Step\Acceptance\User $I)
    {
        ...
        $firstName           = $this->firstName_Auditor5_WithoutState = $I->GenerateNameOf('firnam_5');
        $lastName            = $this->lastName_Auditor5_WithoutState = $I->GenerateNameOf('lastnam_5');
        $password            = $confirmPassword = $this->password;
...
//        $this->nameInspector = $firstName." ".$lastName;
    ...
    public function CreateAuditorUser_WithoutProgram(Step\Acceptance\User $I)
    {
        ...
        $firstName           = $this->firstName_Auditor4_WithoutProgram = $I->GenerateNameOf('firnam_4');
        $lastName            = $this->lastName_Auditor4_WithoutProgram = $I->GenerateNameOf('lastnam_4');
        $password            = $confirmPassword = $this->password;
    ...
    public function CreateAuditorUser_Program1_Program2(Step\Acceptance\User $I)
    {
        ...
        $firstName           = $this->firstName_Auditor3_Prog1_Prog2 = $I->GenerateNameOf('firnam_3');
        $lastName            = $this->lastName_Auditor3_Prog1_Prog2 = $I->GenerateNameOf('lastnam_3');
        $password            = $confirmPassword = $this->password;
    ...
    public function CheckAllUsersListPage_AllStatesSelected(\Step\Acceptance\User $I)
    {
        ...
        $I->wait(5);
        $I->canSeeElement(\Page\UserList::$EmptyListLabel);
    ...
    public function NationalAdmin1_8_CheckAllUsersUpdateAndViewPages(\Step\Acceptance\User $I)
    {
        ...
        $I->canSeeElement(\Page\UserView::BusinessNameLinkLine_ByName($this->business1));
        $I->canSeeElement(\Page\UserView::BusinessNameLinkLine_ByName($this->business1)."[@href='/master-admin/business/index?business_id=$this->id_business1']");
        ...
        $I->amOnPage(\Page\UserUpdate::URL($this->id_business1User)."&ref=all");
        $I->wait(2);
        $I->cantSeePageNotFound($I);
        $I->cantSeePageForbiddenAccess($I);
        $I->canSeeElement(\Page\UserUpdate::$AssignBusinessButton);
        $I->canSeeElement(\Page\UserUpdate::BusinessNameLinkLine_ByName($this->business1));
        $I->canSeeElement(\Page\UserUpdate::BusinessNameLinkLine_ByName($this->business1)."[@href='/master-admin/business/index?business_id=$this->id_business1']");
        $I->canSeeInField(\Page\UserUpdate::$EmailField, $this->email_Business1);
        $I->canSeeInField(\Page\UserUpdate::$FirstNameField, $this->firstName_Business1);
        $I->canSeeInField(\Page\UserUpdate::$LastNameField, $this->lastName_Business1);
        $I->canSee($business_type, \Page\UserUpdate::$SelectedTypeOption);
        $I->canSeeInField(\Page\UserUpdate::$PhoneField, $this->phone_Business1);
        $I->canSee("Home", \Page\UserUpdate::$Breadcrumb_Home);
        $I->canSee("All users", \Page\UserUpdate::$Breadcrumb_UserType);
        $I->canSee("Update user: $this->firstName_Business1 $this->lastName_Business1", \Page\UserUpdate::$Breadcrumb_CurrentUser);
        ...
        $I->canSeeElement(\Page\UserUpdate::$UpdateButton);
        ...
        $I->cantSeePageForbiddenAccess($I);
        $I->cantSeeElement(\Page\UserView::$AssignBusinessButton);
        $I->canSeeElement(\Page\UserView::BusinessNameLinkLine_ByName($this->business2));
        $I->canSeeElement(\Page\UserView::BusinessNameLinkLine_ByName($this->business2)."[@href='/master-admin/business/index?business_id=$this->id_business2']");
        ...
        $I->amOnPage(\Page\UserUpdate::URL($this->id_business2User)."&ref=all");
        $I->wait(2);
        $I->cantSeePageNotFound($I);
        $I->cantSeePageForbiddenAccess($I);
        $I->canSeeElement(\Page\UserUpdate::$AssignBusinessButton);
        $I->canSeeElement(\Page\UserUpdate::BusinessNameLinkLine_ByName($this->business2));
        $I->canSeeElement(\Page\UserUpdate::BusinessNameLinkLine_ByName($this->business2)."[@href='/master-admin/business/index?business_id=$this->id_business2']");
        $I->canSeeInField(\Page\UserUpdate::$EmailField, $this->email_Business2);
        $I->canSeeInField(\Page\UserUpdate::$FirstNameField, $this->firstName_Business2);
        $I->canSeeInField(\Page\UserUpdate::$LastNameField, $this->lastName_Business2);
        $I->canSee($business_type, \Page\UserUpdate::$SelectedTypeOption);
        $I->canSeeInField(\Page\UserUpdate::$PhoneField, $this->phone_Business2);
        $I->canSee("Home", \Page\UserUpdate::$Breadcrumb_Home);
        $I->canSee("All users", \Page\UserUpdate::$Breadcrumb_UserType);
        $I->canSee("Update user: $this->firstName_Business2 $this->lastName_Business2", \Page\UserUpdate::$Breadcrumb_CurrentUser);
        $I->canSeeElement(\Page\UserUpdate::$Breadcrumb_UserType.'[href*="'.AcceptanceTester::$URL_UserAccess.'/user/index?type=all&ref=all'.'"]');
        $I->canSeeElement(\Page\UserUpdate::$BackToListButton.'[href*="'.AcceptanceTester::$URL_UserAccess.'/user/index?type=all&ref=all'.'"]');
        $I->canSeeElement(\Page\UserUpdate::$UpdateButton);
        ...
        $I->canSee("Home", \Page\UserView::$Breadcrumb_Home);
        $I->canSee("All users", \Page\UserView::$Breadcrumb_UserType);
        $I->canSee("View user: $this->firstName_Auditor2_Prog2 $this->lastName_Auditor2_Prog2", \Page\UserView::$Breadcrumb_CurrentUser);
        $I->canSeeElement(\Page\UserView::$Breadcrumb_UserType.'[href*="'.AcceptanceTester::$URL_UserAccess.'/user/index?type=all&ref=all'.'"]');
        $I->canSeeElement(\Page\UserView::$BackToListButton.'[href*="'.AcceptanceTester::$URL_UserAccess.'/user/index?type=all&ref=all'.'"]');
    ...
    public function Coordinator1_CheckBusinessUsersListPage(\Step\Acceptance\User $I)
    {
        ...
        $I->amOnPage(\Page\UserList::URL(\Page\UserCreate::businessType));
        $I->wait(3);
        $I->canSee('1', Page\UserList::$SummaryCount);
        
        //Business 1 user present
        $I->comment("-------------------Business user1 PRESENT------------------");
        $user1 = $I->GetUserOnPageInList($this->email_Business1, Page\UserCreate::businessType);
        $row = $user1['row'];
        $I->canSee($this->email_Business1, \Page\UserList::EmailLine($row));
        $I->canSee($this->firstName_Business1, \Page\UserList::FirstNameLine($row));
        $I->canSee($this->lastName_Business1, \Page\UserList::LastNameLine($row));
    ...
    public function Coordinator2_CheckBusinessUsersListPage(\Step\Acceptance\User $I)
    {
        ...
        //Business 2 user present
        $I->comment("-------------------Business user2 PRESENT------------------");
        $user1 = $I->GetUserOnPageInList($this->email_Business2, Page\UserCreate::businessType);
        $row = $user1['row'];
        $I->canSee($this->email_Business2, \Page\UserList::EmailLine($row));
        $I->canSee($this->firstName_Business2, \Page\UserList::FirstNameLine($row));
        $I->canSee($this->lastName_Business2, \Page\UserList::LastNameLine($row));
    ...
    public function Coordinator3_CheckAllUsersListPage(\Step\Acceptance\User $I)
    {
        ...
        $I->amOnPage(\Page\UserList::URL(\Page\UserCreate::allType));
        $I->wait(3);
        $I->canSee('11', Page\UserList::$SummaryCount);
        
        //Business 1 user present
        $I->comment("-------------------Business user1 ABSENT------------------");
        $user1 = $I->GetUserOnPageInList($this->email_Business1, Page\UserCreate::allType);
        $row = $user1['row'];
        $I->CheckValuesOnUserListPage(\Page\UserCreate::allType, $row, 
                                      $this->email_Business1, 
                                      $this->firstName_Business1, 
                                      $this->lastName_Business1, 
                                      $status, $business_type, 
                                      $updateButton = 'present', 
                                      $deleteButton = 'absent', 
                                      $viewButton = 'absent', 
...
//        $I->canSeeElement(\Page\UserList::ViewButtonLine($row));
        ...
        $row = $user1['row'];
        $I->CheckValuesOnUserListPage(\Page\UserCreate::allType, $row, 
                                      $this->email_Business2, 
                                      $this->firstName_Business2, 
                                      $this->lastName_Business2, 
                                      $status, $business_type, 
                                      $updateButton = 'present', 
                                      $deleteButton = 'absent', 
                                      $viewButton = 'absent', 
...
//        $I->canSeeElement(\Page\UserList::ViewButtonLine($row));
        ...
        $row = $user1['row'];
        $I->CheckValuesOnUserListPage(\Page\UserCreate::allType, $row, 
                                      $this->emailCoordinator3_Prog1_Prog2, 
                                      $this->firstName_Coordinator3_Prog1_Prog2, 
                                      $this->lastName_Coordinator3_Prog1_Prog2, 
...
//        $I->canSeeElement(\Page\UserList::ViewButtonLine($row));
        ...
        $row = $user1['row'];
        $I->CheckValuesOnUserListPage(\Page\UserCreate::allType, $row, 
                                      $this->emailInspector1_Prog1, 
                                      $this->firstName_Inspector1_Prog1, 
                                      $this->lastName_Inspector1_Prog1, 
                                      $status, $inspector_type, 
                                      $updateButton = 'present', 
                                      $deleteButton = 'present', 
                                      $viewButton = 'absent', 
                                      $createdDate = $this->todayDate);
...
//        $I->cantSeeElement(\Page\UserList::ViewButtonLine($row));
        ...
        $row = $user1['row'];
        $I->CheckValuesOnUserListPage(\Page\UserCreate::allType, $row, 
                                      $this->emailInspector2_Prog2, 
                                      $this->firstName_Inspector2_Prog2, 
                                      $this->lastName_Inspector2_Prog2, 
                                      $status, $inspector_type, 
                                      $updateButton = 'present', 
                                      $deleteButton = 'present', 
                                      $viewButton = 'absent', 
...
//        $I->cantSeeElement(\Page\UserList::ViewButtonLine($row));
        ...
        $row = $user1['row'];
        $I->CheckValuesOnUserListPage(\Page\UserCreate::allType, $row, 
                                      $this->emailInspector3_Prog1_Prog2, 
                                      $this->firstName_Inspector3_Prog1_Prog2, 
                                      $this->lastName_Inspector3_Prog1_Prog2, 
                                      $status, $inspector_type, 
                                      $updateButton = 'present', 
                                      $deleteButton = 'present', 
                                      $viewButton = 'absent', 
...
//        $I->cantSeeElement(\Page\UserList::ViewButtonLine($row));
        ...
        $row = $user1['row'];
        $I->CheckValuesOnUserListPage(\Page\UserCreate::allType, $row, 
                                      $this->emailInspector4_WithoutProgram, 
                                      $this->firstName_Inspector4_WithoutProgram, 
                                      $this->lastName_Inspector4_WithoutProgram, 
                                      $status, $inspector_type, 
                                      $updateButton = 'present', 
                                      $deleteButton = 'absent', 
                                      $viewButton = 'absent', 
...
//        $I->cantSeeElement(\Page\UserList::ViewButtonLine($row));
        ...
        $row = $user1['row'];
        $I->CheckValuesOnUserListPage(\Page\UserCreate::allType, $row, 
                                      $this->emailAuditor1_Prog1, 
                                      $this->firstName_Auditor1_Prog1, 
                                      $this->lastName_Auditor1_Prog1, 
                                      $status, $auditor_type, 
                                      $updateButton = 'present', 
                                      $deleteButton = 'present', 
                                      $viewButton = 'absent', 
...
//        $I->cantSeeElement(\Page\UserList::ViewButtonLine($row));
        ...
        $row = $user1['row'];
        $I->CheckValuesOnUserListPage(\Page\UserCreate::allType, $row, 
                                      $this->emailAuditor2_Prog2, 
                                      $this->firstName_Auditor2_Prog2, 
                                      $this->lastName_Auditor2_Prog2, 
                                      $status, $auditor_type, 
                                      $updateButton = 'present', 
                                      $deleteButton = 'present', 
                                      $viewButton = 'absent', 
...
//        $I->cantSeeElement(\Page\UserList::ViewButtonLine($row));
        ...
        $row = $user1['row'];
        $I->CheckValuesOnUserListPage(\Page\UserCreate::allType, $row, 
                                      $this->emailAuditor3_Prog1_Prog2, 
                                      $this->firstName_Auditor3_Prog1_Prog2, 
                                      $this->lastName_Auditor3_Prog1_Prog2, 
                                      $status, $auditor_type, 
                                      $updateButton = 'present', 
                                      $deleteButton = 'present', 
                                      $viewButton = 'absent', 
...
//        $I->cantSeeElement(\Page\UserList::ViewButtonLine($row));
        ...
        $row = $user1['row'];
        $I->CheckValuesOnUserListPage(\Page\UserCreate::allType, $row, 
                                      $this->emailAuditor4_WithoutProgram, 
                                      $this->firstName_Auditor4_WithoutProgram, 
                                      $this->lastName_Auditor4_WithoutProgram, 
                                      $status, $auditor_type, 
                                      $updateButton = 'present', 
                                      $deleteButton = 'absent', 
                                      $viewButton = 'absent', 
...
//        $I->cantSeeElement(\Page\UserList::ViewButtonLine($row));
    ...
    public function Coordinator3_CheckInspectorsUsersListPage(\Step\Acceptance\User $I)
    {
        ...
        $user1 = $I->GetUserOnPageInList($this->emailInspector1_Prog1, Page\UserCreate::inspectorType);
        $row = $user1['row'];
        $I->CheckValuesOnUserListPage(\Page\UserCreate::inspectorType, $row, 
                                      $this->emailInspector1_Prog1, 
                                      $this->firstName_Inspector1_Prog1, 
                                      $this->lastName_Inspector1_Prog1, 
                                      $status, $inspector_type,
...
//        $I->cantSeeElement(\Page\UserList::ViewButtonLine($row));
    ...
    public function Coordinator3_CheckAuditorsUsersListPage(\Step\Acceptance\User $I)
    {
        ...
        $user1 = $I->GetUserOnPageInList($this->emailAuditor1_Prog1, Page\UserCreate::auditorType);
        $row = $user1['row'];
        $I->CheckValuesOnUserListPage(\Page\UserCreate::auditorType, $row, 
                                      $this->emailAuditor1_Prog1, 
                                      $this->firstName_Auditor1_Prog1, 
                                      $this->lastName_Auditor1_Prog1, 
                                      $status, $auditor_type,
...
//        $I->cantSeeElement(\Page\UserList::ViewButtonLine($row));
    ...
    public function Coordinator3_CheckBusinessUsersListPage(\Step\Acceptance\User $I)
    {
        ...
        $user1 = $I->GetUserOnPageInList($this->email_Business1, Page\UserCreate::businessType);
        $row = $user1['row'];
        $I->CheckValuesOnUserListPage(\Page\UserCreate::businessType, $row, 
                                      $this->email_Business1, 
                                      $this->firstName_Business1, 
                                      $this->lastName_Business1, 
                                      $status, $business_type,
...
//        $I->cantSeeElement(\Page\UserList::ViewButtonLine($row));
    ...
    public function Coordinator4_CheckInspectorsUsersListPage(\Step\Acceptance\User $I)
    {
        $status           = 'active';
        $stateAdmin_type  = 'state admin';
        $coordinator_type = 'coordinator';
    ...
    public function Coordinator4_CheckAuditorsUsersListPage(\Step\Acceptance\User $I)
    {
        $status           = 'active';
        $stateAdmin_type  = 'state admin';
        $coordinator_type = 'coordinator';
    ...
    public function Coordinator4_CheckBusinessUsersListPage(\Step\Acceptance\User $I)
    {
        $status           = 'active';
        $stateAdmin_type  = 'state admin';
        $coordinator_type = 'coordinator';
    ...
    public function Coordinator5_CheckInspectorsUsersListPage(\Step\Acceptance\User $I)
    {
        $status           = 'active';
        $stateAdmin_type  = 'state admin';
        $coordinator_type = 'coordinator';
    ...
    public function Coordinator5_CheckAuditorsUsersListPage(\Step\Acceptance\User $I)
    {
        $status           = 'active';
        $stateAdmin_type  = 'state admin';
        $coordinator_type = 'coordinator';
    ...
    public function Coordinator5_CheckBusinessUsersListPage(\Step\Acceptance\User $I)
    {
        $status           = 'active';
        $stateAdmin_type  = 'state admin';
        $coordinator_type = 'coordinator';
