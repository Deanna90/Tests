...
//        $this->idComplianceCheck_StAdm = $comp['id'];
    ...
    public function CreateInspectorOrganization_Program1_Program2(Step\Acceptance\InspectorOrganization $I)
    {
        ...
        $I->wait(3);
        $I->waitForElement(\Page\InspectorOrganizationUpdate::$MemberSelect_AddMemberForm, 60);
        $I->canSee($this->fullName_Auditor1_Prog1, Page\InspectorOrganizationUpdate::$MemberOption_AddMemberForm);
        $I->canSee($this->fullName_Auditor2_Prog2, Page\InspectorOrganizationUpdate::$MemberOption_AddMemberForm);
        $I->canSee($this->fullName_Auditor3_Prog1_Prog2, Page\InspectorOrganizationUpdate::$MemberOption_AddMemberForm);
        $I->cantSee($this->fullName_Auditor4_WithoutProgram, Page\InspectorOrganizationUpdate::$MemberOption_AddMemberForm);
        $I->cantSee($this->fullName_Auditor5_WithoutState, Page\InspectorOrganizationUpdate::$MemberOption_AddMemberForm);
        $I->selectOption(\Page\InspectorOrganizationUpdate::$MemberSelect_AddMemberForm, $this->fullName_Inspector1_Prog1);
        $I->wait(1);
        $I->click(\Page\InspectorOrganizationUpdate::$AddButton_AddMemberForm);
        $I->wait(10);
        ...
        $I->wait(3);
        $I->waitForElement(\Page\InspectorOrganizationUpdate::$MemberSelect_AddMemberForm, 60);
        $I->cantSee($this->fullName_Auditor1_Prog1, Page\InspectorOrganizationUpdate::$MemberOption_AddMemberForm);
        $I->canSee($this->fullName_Auditor2_Prog2, Page\InspectorOrganizationUpdate::$MemberOption_AddMemberForm);
        $I->canSee($this->fullName_Auditor3_Prog1_Prog2, Page\InspectorOrganizationUpdate::$MemberOption_AddMemberForm);
        $I->cantSee($this->fullName_Auditor4_WithoutProgram, Page\InspectorOrganizationUpdate::$MemberOption_AddMemberForm);
        $I->cantSee($this->fullName_Auditor5_WithoutState, Page\InspectorOrganizationUpdate::$MemberOption_AddMemberForm);
        ...
        $I->waitForElement(\Page\InspectorOrganizationUpdate::$MemberSelect_AddMemberForm, 60);
        $I->cantSee($this->fullName_Auditor1_Prog1, Page\InspectorOrganizationUpdate::$MemberOption_AddMemberForm);
        $I->cantSee($this->fullName_Auditor2_Prog2, Page\InspectorOrganizationUpdate::$MemberOption_AddMemberForm);
        $I->canSee($this->fullName_Auditor3_Prog1_Prog2, Page\InspectorOrganizationUpdate::$MemberOption_AddMemberForm);
        $I->cantSee($this->fullName_Auditor4_WithoutProgram, Page\InspectorOrganizationUpdate::$MemberOption_AddMemberForm);
        $I->cantSee($this->fullName_Auditor5_WithoutState, Page\InspectorOrganizationUpdate::$MemberOption_AddMemberForm);
        $I->selectOption(\Page\InspectorOrganizationUpdate::$MemberSelect_AddMemberForm, $this->fullName_Inspector3_Prog1_Prog2);
        ...
        $I->reloadPage();
        $I->wait(6);
        $I->canSeeElement(\Page\InspectorOrganizationUpdate::UserLine_ByName($this->fullName_Auditor3_Prog1_Prog2));
        $I->wait(3);
    }
    ...
    public function CheckAuditPopup_Business1(AcceptanceTester $I) {
        ...
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditGroupByName(\Page\AuditGroupList::Water_AuditGroup));
        ...
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_OrganizationOptionByName(\Page\AuditGroupList::Energy_AuditGroup, $this->auditOrganiz_WithoutAuditors_En_Pol_Gen_Sol));
        ...
        $I->comment("-Check correct audit Organizations shows for Solid group-");
        $I->click(\Page\ApplicationDetails::AuditsPopup_OrganizationSelectByName(\Page\AuditGroupList::SolidWaste_AuditGroup));
        $I->canSeeElement(\Page\ApplicationDetails::AuditsPopup_OrganizationOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->auditOrganiz_1_En_Gen_Sol_Wat));
        $I->canSeeElement(\Page\ApplicationDetails::AuditsPopup_OrganizationOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->auditOrganiz_1_2_Pol_Gen_Sol_Wat));
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_OrganizationOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->auditOrganiz_2_En_Pol_Sol_Wat));
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_OrganizationOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->auditOrganiz_WithoutProgram_En_Pol_Gen_Sol));
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_OrganizationOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->auditOrganiz_WithoutAuditors_En_Pol_Gen_Sol));
        $I->selectOption(\Page\ApplicationDetails::AuditsPopup_OrganizationSelectByName(\Page\AuditGroupList::SolidWaste_AuditGroup), $this->auditOrganiz_1_En_Gen_Sol_Wat);
        $I->wait(3);
        $I->comment("-Check correct users from Organization1 shows for Solid group-");
        $I->click(\Page\ApplicationDetails::AuditsPopup_AuditorSelectByName(\Page\AuditGroupList::SolidWaste_AuditGroup));
        $I->canSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->fullName_Auditor1_Prog1));
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->fullName_Auditor3_Prog1_Prog2));
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->fullName_Auditor2_Prog2));
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->fullName_Auditor4_WithoutProgram));
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->fullName_Auditor5_WithoutState));
        $I->selectOption(\Page\ApplicationDetails::AuditsPopup_OrganizationSelectByName(\Page\AuditGroupList::SolidWaste_AuditGroup), $this->auditOrganiz_1_2_Pol_Gen_Sol_Wat);
        $I->wait(3);
        $I->comment("-Check correct users from Organization1_2 shows for Solid group-");
        $I->click(\Page\ApplicationDetails::AuditsPopup_AuditorSelectByName(\Page\AuditGroupList::SolidWaste_AuditGroup));
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->fullName_Auditor1_Prog1));
        $I->canSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->fullName_Auditor3_Prog1_Prog2));
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->fullName_Auditor2_Prog2));
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->fullName_Auditor4_WithoutProgram));
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->fullName_Auditor5_WithoutState));
        ...
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_OrganizationOptionByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->auditOrganiz_WithoutAuditors_En_Pol_Gen_Sol));
        ...
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->fullName_Auditor1_Prog1));
    ...
    public function CheckAuditPopup_Business2(AcceptanceTester $I) {
        ...
        $I->comment("-Check correct audit Organizations shows for Solid group-");
        $I->click(\Page\ApplicationDetails::AuditsPopup_OrganizationSelectByName(\Page\AuditGroupList::SolidWaste_AuditGroup));
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_OrganizationOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->auditOrganiz_1_En_Gen_Sol_Wat));
        $I->canSeeElement(\Page\ApplicationDetails::AuditsPopup_OrganizationOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->auditOrganiz_1_2_Pol_Gen_Sol_Wat));
        $I->canSeeElement(\Page\ApplicationDetails::AuditsPopup_OrganizationOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->auditOrganiz_2_En_Pol_Sol_Wat));
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_OrganizationOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->auditOrganiz_WithoutProgram_En_Pol_Gen_Sol));
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_OrganizationOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->auditOrganiz_WithoutAuditors_En_Pol_Gen_Sol));
        $I->selectOption(\Page\ApplicationDetails::AuditsPopup_OrganizationSelectByName(\Page\AuditGroupList::SolidWaste_AuditGroup), $this->auditOrganiz_2_En_Pol_Sol_Wat);
        $I->wait(3);
        $I->comment("-Check correct users from Organization2 shows for Solid group-");
        $I->click(\Page\ApplicationDetails::AuditsPopup_AuditorSelectByName(\Page\AuditGroupList::SolidWaste_AuditGroup));
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->fullName_Auditor1_Prog1));
        $I->canSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->fullName_Auditor3_Prog1_Prog2));
        $I->canSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->fullName_Auditor2_Prog2));
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->fullName_Auditor4_WithoutProgram));
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->fullName_Auditor5_WithoutState));
        $I->selectOption(\Page\ApplicationDetails::AuditsPopup_OrganizationSelectByName(\Page\AuditGroupList::SolidWaste_AuditGroup), $this->auditOrganiz_1_2_Pol_Gen_Sol_Wat);
        $I->wait(3);
        ...
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_OrganizationOptionByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->auditOrganiz_1_En_Gen_Sol_Wat));
        $I->canSeeElement(\Page\ApplicationDetails::AuditsPopup_OrganizationOptionByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->auditOrganiz_1_2_Pol_Gen_Sol_Wat));
        $I->canSeeElement(\Page\ApplicationDetails::AuditsPopup_OrganizationOptionByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->auditOrganiz_2_En_Pol_Sol_Wat));
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_OrganizationOptionByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->auditOrganiz_WithoutProgram_En_Pol_Gen_Sol));
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_OrganizationOptionByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->auditOrganiz_WithoutAuditors_En_Pol_Gen_Sol));
        $I->selectOption(\Page\ApplicationDetails::AuditsPopup_OrganizationSelectByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup), $this->auditOrganiz_1_2_Pol_Gen_Sol_Wat);
        $I->wait(3);
        ...
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->fullName_Auditor1_Prog1));
        $I->canSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->fullName_Auditor3_Prog1_Prog2));
        $I->canSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->fullName_Auditor2_Prog2));
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->fullName_Auditor4_WithoutProgram));
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->fullName_Auditor5_WithoutState));
        $I->selectOption(\Page\ApplicationDetails::AuditsPopup_OrganizationSelectByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup), $this->auditOrganiz_2_En_Pol_Sol_Wat);
        $I->wait(3);
        $I->comment("-Check correct users from Organization2 shows for Pollution group-");
        $I->click(\Page\ApplicationDetails::AuditsPopup_AuditorSelectByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup));
        $I->cantSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->fullName_Auditor1_Prog1));
        $I->canSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->fullName_Auditor3_Prog1_Prog2));
        $I->canSeeElement(\Page\ApplicationDetails::AuditsPopup_AuditorOptionByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->fullName_Auditor2_Prog2));
    ...
    public function CheckInspectorPopup_Business1(AcceptanceTester $I) {
        ...
        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName($this->complCheck1, $this->inspOrganiz_WithoutInspectors_C1_C2_C3_C4));
        ...
        $I->canSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName($this->complCheck1, $this->fullName_Inspector1_Prog1));
        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName($this->complCheck1, $this->fullName_Inspector3_Prog1_Prog2));
        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName($this->complCheck1, $this->fullName_Inspector2_Prog2));
        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName($this->complCheck1, $this->fullName_Inspector4_WithoutProgram));
        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName($this->complCheck1, $this->fullName_Inspector5_WithoutState));
        ...
        $I->click(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationSelectByName($this->complCheck2));
        $I->canSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName($this->complCheck2, $this->fullName_Inspector1_Prog1));
        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName($this->complCheck2, $this->fullName_Inspector3_Prog1_Prog2));
        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName($this->complCheck2, $this->fullName_Inspector2_Prog2));
        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName($this->complCheck2, $this->fullName_Inspector4_WithoutProgram));
        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName($this->complCheck2, $this->fullName_Inspector5_WithoutState));
        ...
        $I->click(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationSelectByName($this->complCheck2));
        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName($this->complCheck2, $this->fullName_Inspector1_Prog1));
        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName($this->complCheck2, $this->fullName_Inspector3_Prog1_Prog2));
        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName($this->complCheck2, $this->fullName_Inspector2_Prog2));
        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName($this->complCheck2, $this->fullName_Inspector4_WithoutProgram));
        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName($this->complCheck2, $this->fullName_Inspector5_WithoutState));
        ...
        $I->click(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationSelectByName($this->complCheck3_Created));
        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName($this->complCheck3_Created, $this->fullName_Inspector1_Prog1));
        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName($this->complCheck3_Created, $this->fullName_Inspector3_Prog1_Prog2));
        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName($this->complCheck3_Created, $this->fullName_Inspector2_Prog2));
        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName($this->complCheck3_Created, $this->fullName_Inspector4_WithoutProgram));
        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName($this->complCheck3_Created, $this->fullName_Inspector5_WithoutState));
    }
...
//        $I->comment("-Check correct audit Organizations shows for Energy group-");
//        $I->click(\Page\ApplicationDetails::AuditsPopup_OrganizationSelectByName(\Page\AuditGroupList::Energy_AuditGroup));
//        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::Energy_AuditGroup, $this->auditOrganiz_1_En_Gen_Sol_Wat));
//        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::Energy_AuditGroup, $this->auditOrganiz_1_2_Pol_Gen_Sol_Wat));
//        $I->canSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::Energy_AuditGroup, $this->auditOrganiz_2_En_Pol_Sol_Wat));
//        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::Energy_AuditGroup, $this->auditOrganiz_WithoutProgram_En_Pol_Gen_Sol));
//        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::Energy_AuditGroup, $this->auditOrganiz_WithoutAuditors_En_Pol_Gen_Sol));
//        $I->selectOption(\Page\ApplicationDetails::AuditsPopup_OrganizationSelectByName(\Page\AuditGroupList::Energy_AuditGroup), $this->auditOrganiz_2_En_Pol_Sol_Wat);
//        $I->wait(3);
//        $I->comment("-Check correct users from Organization2 shows for Energy group-");
//        $I->click(\Page\ApplicationDetails::AuditsPopup_AuditorSelectByName(\Page\AuditGroupList::Energy_AuditGroup));
//        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::Energy_AuditGroup, $this->fullName_Auditor1_Prog1));
//        $I->canSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::Energy_AuditGroup, $this->fullName_Auditor3_Prog1_Prog2));
//        $I->canSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::Energy_AuditGroup, $this->fullName_Auditor2_Prog2));
//        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::Energy_AuditGroup, $this->fullName_Auditor4_WithoutProgram));
//        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::Energy_AuditGroup, $this->fullName_Auditor5_WithoutState));
//        
//        $I->comment("-Check correct audit Organizations shows for Solid group-");
//        $I->click(\Page\ApplicationDetails::AuditsPopup_OrganizationSelectByName(\Page\AuditGroupList::SolidWaste_AuditGroup));
//        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->auditOrganiz_1_En_Gen_Sol_Wat));
//        $I->canSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->auditOrganiz_1_2_Pol_Gen_Sol_Wat));
//        $I->canSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->auditOrganiz_2_En_Pol_Sol_Wat));
//        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->auditOrganiz_WithoutProgram_En_Pol_Gen_Sol));
//        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->auditOrganiz_WithoutAuditors_En_Pol_Gen_Sol));
//        $I->selectOption(\Page\ApplicationDetails::AuditsPopup_OrganizationSelectByName(\Page\AuditGroupList::SolidWaste_AuditGroup), $this->auditOrganiz_2_En_Pol_Sol_Wat);
//        $I->wait(3);
//        $I->comment("-Check correct users from Organization2 shows for Solid group-");
//        $I->click(\Page\ApplicationDetails::AuditsPopup_AuditorSelectByName(\Page\AuditGroupList::SolidWaste_AuditGroup));
//        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->fullName_Auditor1_Prog1));
//        $I->canSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->fullName_Auditor3_Prog1_Prog2));
//        $I->canSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->fullName_Auditor2_Prog2));
//        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->fullName_Auditor4_WithoutProgram));
//        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::SolidWaste_AuditGroup, $this->fullName_Auditor5_WithoutState));
//        $I->selectOption(\Page\ApplicationDetails::AuditsPopup_OrganizationSelectByName(\Page\AuditGroupList::SolidWaste_AuditGroup), $this->auditOrganiz_1_2_Pol_Gen_Sol_Wat);
//        $I->wait(3);
//        $I->comment("-Check correct users from Organization1_2 shows for Solid group-");
//        $I->click(\Page\ApplicationDetails::AuditsPopup_AuditorSelectByName(\Page\AuditGroupList::SolidWaste_AuditGroup));
...
//        $I->comment("-Check correct audit Organizations shows for Pollution group-");
//        $I->click(\Page\ApplicationDetails::AuditsPopup_OrganizationSelectByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup));
//        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->auditOrganiz_1_En_Gen_Sol_Wat));
//        $I->canSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->auditOrganiz_1_2_Pol_Gen_Sol_Wat));
//        $I->canSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->auditOrganiz_2_En_Pol_Sol_Wat));
//        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->auditOrganiz_WithoutProgram_En_Pol_Gen_Sol));
//        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->auditOrganiz_WithoutAuditors_En_Pol_Gen_Sol));
//        $I->selectOption(\Page\ApplicationDetails::AuditsPopup_OrganizationSelectByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup), $this->auditOrganiz_1_2_Pol_Gen_Sol_Wat);
//        $I->wait(3);
//        $I->comment("-Check correct users from Organization1_2 shows for Pollution group-");
//        $I->click(\Page\ApplicationDetails::AuditsPopup_AuditorSelectByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup));
//        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->fullName_Auditor1_Prog1));
//        $I->canSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->fullName_Auditor3_Prog1_Prog2));
//        $I->canSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->fullName_Auditor2_Prog2));
//        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->fullName_Auditor4_WithoutProgram));
//        $I->cantSeeElement(\Page\ApplicationDetails::ComplianceCheckPopup_OrganizationOptiomByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup, $this->fullName_Auditor5_WithoutState));
//        $I->selectOption(\Page\ApplicationDetails::AuditsPopup_OrganizationSelectByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup), $this->auditOrganiz_2_En_Pol_Sol_Wat);
//        $I->wait(3);
//        $I->comment("-Check correct users from Organization2 shows for Pollution group-");
//        $I->click(\Page\ApplicationDetails::AuditsPopup_AuditorSelectByName(\Page\AuditGroupList::PollutionPrevention_AuditGroup));
